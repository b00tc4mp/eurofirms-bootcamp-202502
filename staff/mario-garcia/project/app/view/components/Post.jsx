...
export const Post = ({ post, onPostDeleted }) => {
    ...
    return <article className="mb-10 w-full">
        ...
        <div className="flex justify-between">
            ...
            {(post.own || isAdmin) && <button className="border-2 rounded-md bg-blue-50 text-blue-900 px-2 font-medium cursor-pointer" onClick={handleDeleteClick}>Delete</button>}
        </div>
    </article >
}