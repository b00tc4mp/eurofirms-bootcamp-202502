...
//Borramos todos los errores 500 para manejarlos en el handler de errores
...
//en el manejador de todas las rutas metemos: next, el cuál es una funcion encargada de mandarnos a api.use(es decir al siguiente handler que es el manejador de errores)